...
| BUG-011 | Lazy-loading images missing | Minor | Chrome 129, Android 1 | FR-X02 | 1. Load catalog → 2. Scroll | Images load lazily | All images load immediately | Performance issue; affects page load speed |
